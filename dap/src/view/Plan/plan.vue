  ...
  <div class="bannerOrigin-wrap">
    <h5>广告创意</h5>
     ...
     <div class="choos-type">
       ...
       <!-- 新建创意 -->
       <el-col :span="4">
        <el-button type="info" plain>+ 新建创意</el-button>
        </el-col>
        <!-- 批量修改 -->
        <el-col :span="6">
...
export default {
  ...
  methods: {
    ...
    currentPage(index){
     axios.post('http://localhost:9000/banner',{pageIndex:index}).then((res)=>{
  ...
  mounted(){
    axios.post('http://localhost:9000/banner',{pageIndex:1}).then((res)=>{
      console.log(res)
      this.tableData3= res.data
    })
  }, 
